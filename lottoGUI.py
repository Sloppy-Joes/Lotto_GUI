...
class LottoGUI(EasyFrame):
	...
	def __init__(self):
		...
		EasyFrame.__init__(self, title = "Lotto Number Generator", resizable = False, background = "gray20")
		self.addLabel(text = "Lotto Number Generator", row = 0, column = 0, columnspan = 5, sticky = "NSEW", background = "gray20", foreground = "white").config(font = ("Georgia", 16))
		self.addLabel(text = "Here are your 5 standard numbers:", row = 1, column = 0, columnspan = 5, sticky = "NSEW", background = "gray20", foreground = "white")
